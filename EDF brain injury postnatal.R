...
total_data_birth<-total_data_bd[total_data_bd$age_time_ultr %in% c('0','1','2','3','4'),]
...
annotate_figure(together,
                top = text_grob("End-diastolic flow % by day of life for various cerebral MRI results",
